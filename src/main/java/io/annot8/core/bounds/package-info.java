 ...
 *
 * <p>Bounds are the object used to set the extent of an annotation, and will be specific to the
 ...
 *
 * <p>There may be more than one type of valid bound for any given content.
 */
