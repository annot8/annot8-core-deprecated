 ...
 *
 * Content objects have Tags, which describe the type of content contained within it and what
 * processing has been done to it. These are used by processors to decide whether they are able to
 * process it or not.
 *
